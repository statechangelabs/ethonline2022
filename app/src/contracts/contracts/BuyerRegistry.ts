...
export declare namespace BuyerRegistry {
...
export interface BuyerRegistryInterface extends utils.Interface {
  functions: {
...
export interface BuyerRegistry extends BaseContract {
  ...
  functions: {
    ...
    setPolydocs(
      ...
      terms: BuyerRegistry.TermsInfoStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
